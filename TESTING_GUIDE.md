...
1. Abrí el notebook en Google Colab:  
   [![Open in Colab](https://colab.research.google.com/github/santucciandreas/investment-optimization-medallion/blob/master/optimizadordeinversiones_usuario.ipynb)
